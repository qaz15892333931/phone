    ...
    <div>
        <div class="page-head">
            <div>
                ...
                <input slot="left" class="head-input" type="search" v-model="searchVal" placeholder="搜索" >
                <router-link to="/HTN">
        ...
        <div class="page-section">
            <backlog v-for="(item,index) of list" :key="index" :name="item.xm" :sex="item.xb" :age="item.nl" :tel="item.brdh" :card="item.zjhm" :address="item.hjdz" :date="item.jksj" :vid="item.grdaid"></backlog>
        </div>
    </div>
</template>
<script>
