<template>
    <div>
        <mt-header title="新增高血压患者随访服务记录表">
        ...
        <div class="dia-header">
                ...
                <!-- <div style="line-height:25px;">
                    姓名：<span>{{person.xm}}</span>
                </div> -->
                <div style="display:inline-block">
                    <label for="bh">编号:</label>
                    <input type="text" name="bh" v-model="list.sfbh" style="width:80%">
                </div>
        ...
        <div style="background:#fff">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3" placeholder="请选择症状">
                ...
                <tr>
                    ...
                    <td>血压（mmHg）</td>
                    <td colspan="2">
                        <input placeholder="收缩压" v-model="list.ssy" style="width:40%" type="number">/<input  placeholder="舒展压"  v-model="list.szy" style="width:40%" type="number">
                    </td>
                </tr>
                <tr>
                    <td>身高（cm）</td>
                ...
                <tr>
                    <td>体重（kg）</td>
                    <td colspan="2">
                        <input placeholder="当前体重" v-model="list.tz" style="width:40%" type="number">/<input placeholder="目标体重" v-model="list.mbtz" style="width:40%" type="number">
                    </td>
                </tr>
                <tr>
                    <td style="width:35%">体质指数（BMI）（kg/m²）</td>
                    <td colspan="2">
                        <input placeholder="" v-model="list.bmi" type="number" style="width:40%" readonly>/<input placeholder="" v-model="list.mbbmi" type="number" style="width:40%" readonly>
                    </td>
                </tr>
                <tr>
                    <td>心率（次/分钟）</td>
                ...
                <tr style="border-bottom: 1px solid #ddd;">
                    ...
                    <td colspan="2">
                        <input v-model="list.fzjc" type="text" style="width:100%" required>
                    </td>
                </tr>
                <tr style="border-bottom: 1px solid #ddd;">
                    <td colspan="2">服药依从性</td>
                    <td colspan="3">
                        <select v-model="list.fyycx" style="width:50%" id="rely">
                ...
                <tr style="border-bottom: 1px solid #ddd;">
                    ...
                    <td colspan="3">
                        <select v-model="list.ywblfybz" style="width:50%" id="respon">
                ...
                <tr style="border-bottom: 1px solid #ddd;">
                    ...
                    <td colspan="2">
                        ...
                        科室:<input v-model="list.zzksmv" style="width:30%" type="text">
                    </td>
                </tr>
                <tr style="border-bottom: 1px solid #ddd;">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select v-model="list.sfysgh" style="width:100%" id="sfysgh">
...
export default {
    ...
    methods:{
            ...
            if(this.dates.length>1){
                for(var i=0;i<this.dates.length;i++){
                    if($("#history").find("option:selected").text()==this.dates[i].date){
                        this.axios.get("/tbGxyHzsfk/selectByVid/"+this.dates[i].vid).then(res=>{
                            this.list=res.data
                            this.ysg()
                        })
                    }
        ...
        save(){
            ...
            if(this.$vuerify.check()){ // 手动触发校验所有数据
                ...
                this.ys()
               http.post("/tbGxyHzsfk/add",this.$qs.stringify(this.list),{},res=>{
                    // console.log(res)                 
                    MessageBox("提示","提交成功")
                    //修改后的页面
    ...
    mounted(){
        ...
        this.list.sfrq=this.myDate
        console.log( this.myDate)
        console.log(this.list.sfrq)
        //改为grdaid   
